...
library UniswapV4RouterLibrary {
  ...
  function addLiquidity(
    ...
    calls[0] = Call({
      ...
      data: abi.encodeWithSelector(
        manager.modifyPosition.selector, poolKey, modifyPositionParams, EMPTY_DATA
        )
    });

    // Transfer token0 to Pool Manager
    bytes memory paramData =
      abi.encode(Currency.unwrap(poolKey.currency0), sender, address(manager), true);
    calls[1] = Call({
      target: callback,
      ...
      value: 0,
      data: abi.encodeWithSelector(
        UniswapV4RouterLibrary.addLiquidityCallback.selector, paramData, EMPTY_DATA
        )
    });
  ...
  function removeLiquidity(
    ...
    bytes memory callbackData = abi.encodeWithSelector(
      UniswapV4RouterLibrary.removeLiquidityCallback.selector, callData, EMPTY_DATA
    );
    calls[1] = Call({
      target: callback,
      callType: CallType.Delegate,
  ...
  function swap(
    ...
    calls[1] = Call({
      ...
      value: 0,
      data: abi.encodeWithSelector(
        IERC20Minimal.transferFrom.selector, swapper, address(manager), swapAmount
        )
    });
  ...
  function swapManagerTokens(
    ...
    // Transfer ERC1155 tokens in the Pool Manager from the caller to Pool Manager using
    // transferFromCallerToPoolManager callback
    calls[1] = Call({
      target: callback,
      callType: CallType.Call,
      results: false,
      value: 0,
      data: abi.encodeWithSelector(
        UniswapV4RouterLibrary.transferFromCallerToPoolManager.selector,
    ...
    bytes memory callData = abi.encode(manager, toCurrency, recipient, zeroForOne);
    bytes memory callbackData = abi.encodeWithSelector(
      UniswapV4RouterLibrary.swapManagerTokensCallback.selector, callData, EMPTY_DATA
    );
    calls[3] = Call({
      target: callback,
      callType: CallType.Delegate,
  ...
  function deposit(
    ...
    calls[0] = Call({
      ...
      value: 0,
      data: abi.encodeWithSelector(
        IERC20Minimal.transferFrom.selector, sender, address(manager), amount
        )
    });
  ...
  function withdraw(
    ...
    calls[0] = Call({
      ...
      value: 0,
      data: abi.encodeWithSelector(
        UniswapV4RouterLibrary.transferFromCallerToPoolManager.selector, token, amount
        )
    });
